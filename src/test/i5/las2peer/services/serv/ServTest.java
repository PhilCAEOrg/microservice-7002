 ...
 * 7002 - Test Class
 *
 * This class provides a basic testing framework for the microservice 7002. It was
...
public class ServTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(Serv.class.getCanonicalName(),"0.1");

  private static final String mainPath = "service";
  ...
  /**
   * 
   * Test for the getService method.
   * 
   */
  @Test
  public void testgetService() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/service", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testgetService': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
