...
@ServicePath("service")
@ManualDeployment
public class Serv extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "7002", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-7002/blob/master/LICENSE.txt") ) )
  @Path("/")
  public static class RootResource {

    private final Serv service = (Serv) Context.getCurrent().getService();
  ...
  @ApiOperation(value = "getService", notes = " ")
